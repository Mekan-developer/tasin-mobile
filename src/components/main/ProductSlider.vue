            ...
            <div class="slide-left">
              <div class="slide-text">
                ...
                <div v-if="slide.price != null || slide.discount" class="price-block">
                  ...
                  <span v-if="slide.oldPrice != null" class="old-price">{{ formatPrice(slide.oldPrice) }}</span>
                </div>
              </div>
...
/** Форматирует цену: число → "89 990 ₽" */
function formatPrice(value) {
  if (value == null || value === '') return ''
  const num = typeof value === 'number' ? value : parseInt(String(value).replace(/\s/g, ''), 10)
